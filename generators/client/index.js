...
const writeFiles = require('./templates/files-angular').writeFiles;
...
module.exports = class extends ClientGenerator {
    constructor(args, opts) {
        ...
        if (!jhContext) {
            this.error(`This is a JHipster blueprint and should be used only like ${chalk.yellow('jhipster --blueprint login-page')}`);
        }
